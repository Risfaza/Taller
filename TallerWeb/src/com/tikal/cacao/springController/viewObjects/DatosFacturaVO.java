...
public class DatosFacturaVO {
	...
	private C_CodigoPostal lugarDeExpedicion;
	...
	public DatosFacturaVO(String lugarDeExpedicion, String nombreEmisor, Emisor emisor, String[] emails) {
		this.lugarDeExpedicion = new C_CodigoPostal(lugarDeExpedicion);
	 ...
	 */
	public C_CodigoPostal getLugarDeExpedicion() {
	 ...
	 */
	public void setLugarDeExpedicion(C_CodigoPostal lugarDeExpedicion) {
