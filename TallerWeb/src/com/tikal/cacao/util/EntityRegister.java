...
import com.tikal.cacao.model.ConjuntoIAS;
...
import com.tikal.cacao.model.FacturaRenglon;
...
import com.tikal.cacao.model.TrabajadorIAS;
...
public class EntityRegister {
	...
	public EntityRegister() {
		...
		registrar(FacturaRenglon.class);

		registrar(Municipio.class);
		registrar(CFDINominaAsimilado.class);
		registrar(NominaIASRenglon.class);
		registrar(ListaDeClasesDeProdServ.class);
		registrar(TrabajadorIAS.class);
		registrar(FacturaVTT.class);
		registrar(ConjuntoIAS.class);
	}
